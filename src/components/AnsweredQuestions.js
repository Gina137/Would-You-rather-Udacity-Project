...
class  AnsweredQuestions extends Component{
    render(){
        ...
        return(
                ...
                // mapping on sorted question according to timestamps then if autheduser found and in their answers  id for this question it will render it
                (authedUser&&Object.keys(authedUser.answers).includes(idq.id))?(
                <li key={idq.id}>
                    <div className ="card">
                    <Link to={`detailsAnsweredQ/${idq.id}`}>
